...
internally to map simulated claims back to their parent policy.
...
The reported loss at age $a$ is then computed as
\[
...
\textbf{Column} & \textbf{Description} \\
\midrule
\texttt{accident\_year}     & Calendar year of the claim's incurred date. \\
...
\texttt{incurred\_loss}     & Reported (incurred) loss at this age. \\

...
\texttt{truncate\_data(self, remove\_values=None, lower=None, upper=None, q\_low=None, q\_high=None, dropna=True, inplace=True)} &
...
\texttt{num\_sim}      & Number of simulations or number of years in catastrophe modelling. \\
\texttt{keep\_all}     & If \texttt{True}, retain individual event records. \\
\texttt{seed}          & Random seed. \\
\texttt{correlation}   & Optional correlation between frequency and severity. \\

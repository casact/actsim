...
\actsim depends on the companion package \texttt{actstats}, which provides
actuarial-style wrappers around standard statistical distributions. The
\texttt{actstats} package exposes a familiar interface for fitting,
sampling, and evaluating distributions, and it is the engine behind
\actsim's distribution fitting and stochastic simulation classes.
